...
class Article(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.PROTECT, related_name="help_article_creation_user")
    updated_at = models.DateTimeField(auto_now=True)
    updated_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="help_article_update_user")
