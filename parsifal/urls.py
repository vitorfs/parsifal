...
urlpatterns = patterns('',
    ...
    (r'^support/$', 'core.views.support'),
    (r'^explore/$', 'core.views.explore'),
    ...
    (r'^(?P<username>[\w-]+)/(?P<review_name>[\w-]+)/conducting/search/$', 'reviews.conducting.views.search_string'),
    (r'^(?P<username>[\w-]+)/(?P<review_name>[\w-]+)/conducting/studies/$', 'reviews.conducting.views.study_selection'),
    (r'^(?P<username>[\w-]+)/(?P<review_name>[\w-]+)/conducting/quality/$', 'reviews.conducting.views.quality_assessment'),
    (r'^(?P<username>[\w-]+)/(?P<review_name>[\w-]+)/conducting/extraction/$', 'reviews.conducting.views.data_extraction'),
