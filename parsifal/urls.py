...
urlpatterns = patterns(
    ...
    url(
        ...
        "authentication.views.reset_confirm",
    ...
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/planning/protocol/$",
        "reviews.planning.views.protocol",
        name="protocol",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/planning/quality/$",
        "reviews.planning.views.quality_assessment_checklist",
        name="quality_assessment_checklist",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/planning/extraction/$",
        "reviews.planning.views.data_extraction_form",
        name="data_extraction_form",
    ),
    # Conducting Phase
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/conducting/$",
        "reviews.conducting.views.conducting",
        name="conducting",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/conducting/search/$",
        "reviews.conducting.views.search_studies",
        name="search_studies",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/conducting/import/$",
        "reviews.conducting.views.import_studies",
        name="import_studies",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/conducting/studies/$",
        "reviews.conducting.views.study_selection",
        name="study_selection",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/conducting/quality/$",
        "reviews.conducting.views.quality_assessment",
        name="quality_assessment",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/conducting/extraction/$",
        "reviews.conducting.views.data_extraction",
        name="data_extraction",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/conducting/analysis/$",
        "reviews.conducting.views.data_analysis",
        name="data_analysis",
    ),
    # Reporting Phase
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/reporting/$",
        "reviews.reporting.views.reporting",
        name="reporting",
    ),
    url(
        r"^(?P<username>[^/]+)/(?P<review_name>[^/]+)/reporting/export/$",
        "reviews.reporting.views.export",
        name="export",
    ),
