...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reviews_searchsession', (
            ...
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.Source'])),
            ('search_string', self.gf('django.db.models.fields.TextField')(max_length=2000, null=True)),
        ))
    ...
    models = {
        ...
        u'reviews.searchsession': {
            ...
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reviews.Source']"})
        },
