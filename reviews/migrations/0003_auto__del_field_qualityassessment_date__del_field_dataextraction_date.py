...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QualityAssessment.date'
        db.delete_column(u'reviews_qualityassessment', 'date')

        # Deleting field 'DataExtraction.date'
        db.delete_column(u'reviews_dataextraction', 'date')


    def backwards(self, orm):
        # Adding field 'QualityAssessment.date'
        db.add_column(u'reviews_qualityassessment', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 20, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'DataExtraction.date'
        db.add_column(u'reviews_dataextraction', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 3, 20, 0, 0), blank=True),
                      keep_default=False)
