...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SearchSession.source'
        db.alter_column(u'reviews_searchsession', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.Source'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SearchSession.source'
        raise RuntimeError("Cannot reverse this migration. 'SearchSession.source' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SearchSession.source'
        db.alter_column(u'reviews_searchsession', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.Source']))
