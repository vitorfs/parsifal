...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reviews_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Article.journal'
        db.alter_column(u'reviews_article', 'journal', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Article.note'
        db.alter_column(u'reviews_article', 'note', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # Changing field 'Article.title'
        db.alter_column(u'reviews_article', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Article.journal'
        db.alter_column(u'reviews_article', 'journal', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Article.note'
        db.alter_column(u'reviews_article', 'note', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
