...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.author_keywords'
        db.delete_column(u'reviews_article', 'author_keywords')

        # Deleting field 'Article.search_session'
        db.delete_column(u'reviews_article', 'search_session_id')

        # Deleting field 'Article.note'
        db.delete_column(u'reviews_article', 'note')

        # Adding field 'Article.comments'
        db.add_column(u'reviews_article', 'comments',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=4000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.author_keywords'
        db.add_column(u'reviews_article', 'author_keywords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Adding field 'Article.search_session'
        db.add_column(u'reviews_article', 'search_session',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reviews.SearchSession'], null=True),
                      keep_default=False)

        # Adding field 'Article.note'
        db.add_column(u'reviews_article', 'note',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1000, blank=True),
                      keep_default=False)

        # Deleting field 'Article.comments'
        db.delete_column(u'reviews_article', 'comments')
